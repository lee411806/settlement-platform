...
import com.sparta.streamingservice.batch.repo.WeekViewPlaytimeRepository;
...
public class WeekStaticBatch {
    ...
    public Step weeklyStatisticsStep() {
        return new StepBuilder("weeklyStatisticsStep", jobRepository)
                .<DailyVideoView, WeekViewPlaytime>chunk(100, platformTransactionManager) // chunk 크기 설정
    ...
    // Writer 구성
    @Bean(name = "MonthStatisticsLogWriter")
